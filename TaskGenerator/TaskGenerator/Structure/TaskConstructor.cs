        ...
        private static Task CreateTaskType7(ref Random random, int subtype)
        {
            switch (subtype)
            {
                case 1:
                    ...
                    task1.condition = "В скачках участвуют три лошади. Первая лошадь выигрывает скачки с вероятностью " + prob1 + ", вторая - " + prob2 + ", третья - " + prob3 + ". Какова вероятность того, что лошадь, на которую поставил игрок, придет на скачках первой, если он выбирает ее на удачу?";
        ...
        private static Task CreateTaskType18(ref Random random, int subtype)
        {
            switch (subtype)
            {
                case 1:
                    ...
                    task1.questions.Add("найти функцию распределeния F(x)");
                    task1.questions.Add("найти P(α≤x≤β) для данных α,β");
            ...
            switch (subtype)
            {
                case 1:
                    ...
                    task1.condition = "Производится взвешивание стандартных узлов. Систематические ошибки " +
                        "взвешивания отсутют, а случайные — подчинены нормальному закону " +
